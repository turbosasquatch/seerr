...
const messages = defineMessages('components.Discover.DiscoverMdbList', {
  mdblist: 'MDBList',
  activefilters:
    '{count, plural, one {# Active Filter} other {# Active Filters}}',
  sortMdbListOrder: 'MDBList Order',
        ...
        <div className="mt-2 flex flex-grow flex-col sm:flex-row lg:flex-grow-0">
          <div className="mb-2 flex flex-grow sm:mb-0 sm:mr-2 lg:flex-grow-0">
            ...
            <select
              ...
              value={preparedFilters.sortBy || SortOptions.MdbListOrder}
              onChange={(e) =>
                updateQueryParams('sortBy', e.target.value || undefined)
              }
            >
              <option value={SortOptions.MdbListOrder}>
                {intl.formatMessage(messages.sortMdbListOrder)}
              </option>
...
export default DiscoverMdbList;
